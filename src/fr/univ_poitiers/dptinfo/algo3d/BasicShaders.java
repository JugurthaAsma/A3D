...
abstract public class BasicShaders
{
    ...
    static protected int initializeShadersFromResources(GL2 gl, String vertname,String fragname)
    {		
        int shaderprogram=0;
        try
        {
	 ...
	 */
	public void setPositionsPointer(final int size, final int dtype, final int stride, final FloatBuffer buffer)
	{
